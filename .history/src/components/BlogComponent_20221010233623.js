        ...
        <div className="container">
          ...
          >
            <div className="col-md-4 col-sm-6 col-xxs-12">
              ...
              >
                <img src={privacy} alt="blog1" className="img-responsive" />
            ...
            <div className="col-md-4 col-sm-6 col-xxs-12">
              <Link
                ...
                className="fh5co-project-item image-popup to-animate"
              >
                <img src={distributed} alt="blog2" className="img-responsive" />
                <div className="fh5co-text">
                  <h2>Distributed</h2>
                  <span>
            ...
            <div className="col-md-4 col-sm-6 col-xxs-12">
              <Link
                ...
                className="fh5co-project-item image-popup to-animate"
              >
                <img src={audit} alt="blog3" className="img-responsive" />
                <div className="fh5co-text">
                  <h2>Auditability</h2>
                  <span>
