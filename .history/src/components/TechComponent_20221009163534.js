		...
		<div className="container">
			...
			<div className="row row-bottom-padded-sm">
				<div className="col-md-4 col-sm-6 col-xxs-12">
					<a href="images/privacy_acs.jpg" className="fh5co-project-item image-popup to-animate">
						<img src="images/privacy_acs.jpg" alt="Image" className="img-responsive">
				...
				<div className="col-md-4 col-sm-6 col-xxs-12">
					<a href="images/distributed_acs.jpg" className="fh5co-project-item image-popup to-animate">
						<img src="images/distributed_acs.jpg" alt="Image" className="img-responsive">
						<div className="fh5co-text">
							<h2>Distributed</h2>
				...
				<div className="col-md-4 col-sm-6 col-xxs-12">
					<a href="images/audit_acs.jpg" className="fh5co-project-item image-popup to-animate">
						<img src="images/audit_acs.jpg" alt="Image" className="img-responsive">
						<div className="fh5co-text">
							<h2>Auditability</h2>
